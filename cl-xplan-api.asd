		  ...
		  ((:file "package")
		   ...
		   (:module
		    ...
		    (;; access
		     ...
		     (:file "entity/client/debt_qualifier/au/scenario")
		     (:file "entity/client/debt_qualifier/au/scenario/addback")
		     (:file "entity/client/debt_qualifier/au/scenario/applicant")
		     (:file "entity/client/debt_qualifier/au/scenario/application_detail")
		     (:file "entity/client/debt_qualifier/au/scenario/calculator/aapr")
		     (:file "entity/client/debt_qualifier/au/scenario/calculator/maxloan")
		     (:file "entity/client/debt_qualifier/au/scenario/current_loan")
		     (:file "entity/client/debt_qualifier/au/scenario/expense")
		     (:file "entity/client/debt_qualifier/au/scenario/funding_detail")
		     (:file "entity/client/debt_qualifier/au/scenario/income")
		     (:file "entity/client/debt_qualifier/au/scenario/lender_list_report")
		     (:file "entity/client/debt_qualifier/au/scenario/lender_maxloan_report")
		     (:file "entity/client/debt_qualifier/au/scenario/lender_result")
		     (:file "entity/client/debt_qualifier/au/scenario/main_info")
		     (:file "entity/client/debt_qualifier/au/scenario/mortgage_research_report")
		     (:file "entity/client/debt_qualifier/au/scenario/product_comparison_report")
		     (:file "entity/client/debt_qualifier/au/scenario/product_list_report")
		     (:file "entity/client/debt_qualifier/au/scenario/product_selection_report")
		     (:file "entity/client/debt_qualifier/au/scenario/property")
		     (:file "entity/client/debt_qualifier/au/scenario/proposed_loan")
		     (:file "entity/client/debt_qualifier/au/scenario/repayment_offset")
		     (:file "entity/client/debt_qualifier/au/scenario/scenario_attachment")
		     (:file "entity/client/debt_qualifier/au/scenario/security")
		     (:file "entity/client/debt_qualifier/au/scenario/selected_product")
		     (:file "entity/client/debt_qualifier/au/scenario/summary_note")
