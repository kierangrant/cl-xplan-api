...
;; GET /resourceful/family_tree/:family_tree_id/association
(define-entrypoint family_tree/association :get
  (family_tree_id) ()
  :resource (format nil "/family_tree/~A/association" family_tree_id))

;; POST /resourceful/family_tree/:family_tree_id/association
...
;; PUT /resourceful/family_tree/:family_tree_id/association/:association_id
