...
;; GET /resourceful/eapplications/product_type and GET /resourceful/eapplications/product_type/:type_id
(define-entrypoint eapplications/product_type :get
  (type_id)
  ()
  :resource (format nil "/eapplications/product_type~@[/~A~]" type_id))

;; POST /resourceful/eapplications/product_type
...
;; PATCH /resourceful/eapplications/product_type/:type_id
