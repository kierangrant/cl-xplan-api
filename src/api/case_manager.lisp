...
;; GET /resourceful/case_manager and GET /resourceful/case_manager/:container_id
...
;; PATCH /resourceful/case_manager/:container_id
...
;; DELETE /resourceful/case_manager/:container_id
...
;; GET /resourceful/case_manager-v2
...
;; POST /resourceful/case_manager-v2
...
;; GET /resourceful/case_manager/:container_id/benchmark
...
;; GET /resourceful/case_manager/:container_id/debt_qualifier_scenario
...
;; POST /resourceful/case_manager/:container_id/debt_qualifier_scenario
...
;; DELETE /resourceful/case_manager/:container_id/debt_qualifier_scenario/:linked_obj_id
...
;; GET /resourceful/case_manager/:container_id/diary
...
;; POST /resourceful/case_manager/:container_id/diary
(cl-xplan-api/core::define-entrypoint case_manager/diary :post
  (container_id) (linked_obj_id ((benchmarkable nil benchmarkable-p) :cond benchmarkable-p :value (if benchmarkable 1 0)))
  :resource (format NIL "/case_manager/~A/diary" container_id))

;; DELETE /resourceful/case_manager/:container_id/diary/:linked_obj_id
...
;; GET /resourceful/case_manager/:container_id/docnote
...
;; POST /resourceful/case_manager/:container_id/docnote
(cl-xplan-api/core::define-entrypoint case_manager/docnote :post
  (container_id) (linked_obj_id ((benchmarkable nil benchmarkable-p) :cond benchmarkable-p :value (if benchmarkable 1 0)))
  :resource (format NIL "case_manager/~A/docnote" container_id))

;; DELETE /resourceful/case_manager/:container_id/docnote/:linked_obj_id
...
;; GET /resourceful/case_manager/:container_id/fee_for_service
...
;; POST /resourceful/case_manager/:container_id/fee_for_service
...
;; DELETE /resourceful/case_manager/:container_id/fee_for_service/:linked_obj_id
...
;; GET /resourceful/case_manager/:container_id/fsg
...
;; POST /resourceful/case_manager/:container_id/fsg
(cl-xplan-api/core::define-entrypoint case_manager/fsg :post
  (container_id) (linked_obj_id ((benchmarkable nil benchmarkable-p) :cond benchmarkable-p :value (if benchmarkable 1 0)))
  :resource (format NIL "case_manager/~A/fsg" container_id))

;; DELETE /resourceful/case_manager/:container_id/fsg/:linked_obj_id
...
;; GET /resourceful/case_manager/:container_id/goal
...
;; POST /resourceful/case_manager/:container_id/goal
...
;; POST /resourceful/case_manager/:container_id/goal?_method=sort - Unsure if in Bulk I can use 'SORT' method...
...
;; DELETE /resourceful/case_manager/:container_id/goal/:goal_id
...
;; GET /resourceful/case_manager/:container_id/lead
...
;; POST /resourceful/case_manager/:container_id/lead
...
;; DELETE /resourceful/case_manager/:container_id/lead/:lead_id
